																...
																if(isset($_POST['search'])) {
																	...
																	$row = mysqli_fetch_array($query_run)
																		...
																		<thead>
																			...
																			<td class="st-b">FAGS/PRY/2020/<?php echo $row['st_id'] ?></td>
																			</tr>
																		</thead>
																		<?php
                                                            ...
                                                            <div class="remark">
                                                                ...
                                                                <div class="teacher-signature principal">
                                                                    <p class="teacher-sig">Principal's Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <input type="text" class="remark-input principal-name" style="font-size: 13px;" value=" Dcn. Mrs. Roseline Odudu">
                                                                    </p>
